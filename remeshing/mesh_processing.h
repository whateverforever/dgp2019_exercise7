...
using std::string;
enum REMESHING_TYPE : int { UNIFORM = 0, ADAPTIVE = 1};
...
public:
    float get_target_length(){ return target_length_;}
    void  set_target_length(float value){target_length_ = value;}
